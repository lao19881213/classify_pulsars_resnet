    ...
    with tf.Session() as sess:
        ...
        for epoch in range(FLAGS.num_epochs):
            ...
            for i in range(val_batches_per_epoch):
                ...
                val_loss, acc, val_out = sess.run([cost, accuracy, output], feed_dict={x: batch_tx, y: batch_ty, is_training: False})
                test_acc += acc
                val_loss += val_loss
                test_count += 1
            ...
            print("{} Validation Accuracy = {:.4f}, loss = {:.4f}".format(datetime.datetime.now(), test_acc, val_loss))
