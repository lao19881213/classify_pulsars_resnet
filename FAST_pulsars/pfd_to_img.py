...
pfd_data = pfddata("/o9000/MWA/GLEAM/FAST_pulsars/PICS-ResNet_data/train_data/pulsar/FP20171018_0-1GHz_4C-06.18_drifting_0355_DM18.30_172.08ms_Cand.pfd") 
subbands_data = pfd_data.getdata(subbands=64)
print(subbands_data.shape)
subbands_data = subbands_data.reshape((64,64))
...
ax.set_axis_off()
#fig.add_axes(ax)
plt.imshow(subbands_data, origin='lower',  aspect='auto', interpolation='bilinear', cmap=plt.cm.Greys)
